...
class Sport extends CI_Controller{
   ...
   public function index() {
      ...
      $this->load->view('menu' , array(
		...
		$this->load->view('calender' , array(
         'urlaction' => site_url('sport/showbydate') ,
         'urlview' => site_url('sport') ,
         'urlshow' => site_url('sport/show') ,
         'event' => $event ,
         'month' => $month ,
         'year' => $year
      ));
   ...
   public function view($url) {
      ...
      $this->load->view('head-event-view' ,array(
         ...
         'metaURL' => site_url('sport/' . $event->arURL) ,
         ...
         foreach ($value as $data) {
            ...
            $message .= "  <ol>
                           <a is='az-anchorajax'
                              ...
                              action='" . site_url('sport/show/' . $data->arURL) . "'
                              method='click'
                           > " . $data->arTitle . " </a>
                        </ol>
                     ";
