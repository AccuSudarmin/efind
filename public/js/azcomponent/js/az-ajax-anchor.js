(function() {
   var azanchorajax = Object.create(HTMLAnchorElement.prototype);

   azanchorajax.createdCallback = function () {
   ...
   azanchorajax.attachedCallback = function() {
      this.activateSubmit();
   }

   document.registerElement('az-anchorajax', {
      prototype: azanchorajax ,
      extends: 'a'
   });
})();
